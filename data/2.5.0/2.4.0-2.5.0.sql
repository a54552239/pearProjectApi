...
ALTER TABLE `pearproject`.`pear_member` ADD COLUMN `dingtalk_userid` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '钉钉用户id' AFTER `dingtalk_unionid`;
