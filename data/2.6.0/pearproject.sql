...
CREATE TABLE `pear_project_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4464 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '项目日志表' ROW_FORMAT = Compact;
...
INSERT INTO `pear_project_log` VALUES (4458, 'nsti9goruhakc34xw2md0b7p', '6v7be19pwman2fird04gqu53', 'Angular', '编辑了项目 ', 'edit', '2019-06-26 14:13:53', 'sbklfvyouc0qpmwhitn47j5z', 'project', '', 0, 'sbklfvyouc0qpmwhitn47j5z', 'edit');
INSERT INTO `pear_project_log` VALUES (4459, 'ugf52ld8ojkqxa4rzcp7hm13', '6v7be19pwman2fird04gqu53', 'Alians', '邀请 Alians 加入项目', 'inviteMember', '2019-06-26 14:15:01', 'sbklfvyouc0qpmwhitn47j5z', 'project', 'kqdcn2w40p58r31zyo6efjib', 0, 'sbklfvyouc0qpmwhitn47j5z', 'user-add');
INSERT INTO `pear_project_log` VALUES (4460, 'dymctxshnvq604frukwi8oae', '6v7be19pwman2fird04gqu53', 'Chihiro', '邀请 Chihiro 加入项目', 'inviteMember', '2019-06-26 14:15:29', 'sbklfvyouc0qpmwhitn47j5z', 'project', 'y680trgedcavbhnz24u7i5m3', 0, 'sbklfvyouc0qpmwhitn47j5z', 'user-add');
INSERT INTO `pear_project_log` VALUES (4461, 'fhtyx80api1jnc6k724dw3v5', '6v7be19pwman2fird04gqu53', 'Json', '邀请 Json 加入项目', 'inviteMember', '2019-06-26 14:15:35', 'sbklfvyouc0qpmwhitn47j5z', 'project', 'vys8gd32cfui6brtwzj4pqho', 0, 'sbklfvyouc0qpmwhitn47j5z', 'user-add');
INSERT INTO `pear_project_log` VALUES (4462, 'sgi79r02adzc5exhoby4qmtn', '6v7be19pwman2fird04gqu53', '应聘者 孙立平', '创建了任务 ', 'create', '2019-06-26 14:41:01', 'pvt5nm7u49hi3ckr0a1zqgbe', 'task', '', 0, 'sbklfvyouc0qpmwhitn47j5z', 'plus');
INSERT INTO `pear_project_log` VALUES (4463, 'nfq2txjrzlogde3khv01m8wu', '6v7be19pwman2fird04gqu53', '', '认领了任务 ', 'claim', '2019-06-26 14:41:01', 'pvt5nm7u49hi3ckr0a1zqgbe', 'task', '', 0, 'sbklfvyouc0qpmwhitn47j5z', 'user');
...
) ENGINE = InnoDB AUTO_INCREMENT = 12362 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '任务表' ROW_FORMAT = Compact;
...
CREATE TABLE `pear_task_member`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 272 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '任务-成员表' ROW_FORMAT = Compact;
