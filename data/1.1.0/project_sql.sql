...
) ENGINE = MyISAM AUTO_INCREMENT = 157 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限规则' ROW_FORMAT = Dynamic;
...
INSERT INTO `pms_auth_rule` VALUES (154, 'Project_Task.addTaskTag', '添加任务标签', 1, '', 50, 0, '添加任务标签');
INSERT INTO `pms_auth_rule` VALUES (155, 'Project_Task.editTaskTag', '编辑任务标签', 1, '', 50, 0, '编辑任务标签');
INSERT INTO `pms_auth_rule` VALUES (156, 'Project_Task.delTaskTag', '删除任务标签', 1, '', 50, 0, '删除任务标签');
...
) ENGINE = MyISAM AUTO_INCREMENT = 2519 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '日志表' ROW_FORMAT = Dynamic;
...
INSERT INTO `pms_system_log` VALUES (2518, '用户登录，编号：[119]', 119, 'User_User.Login', '2018-07-24 20:47:06');
...
-- Records of pms_user
-- ----------------------------
INSERT INTO `pms_user` VALUES (119, 'xiaoming', 'e10adc3949ba59abbe56e057f20f883e', '晓铭', '', 'http://static.vilson.xyz/20180125090137_0f86640ec585672774958549f1bc3cda', '0000-00-00', '54553@qq.com', '545566999', '1868114085', '', '', '', '2018-01-18', 270, '127.0.0.1', 1532436426, '0', 1, 10, 1, 'xxx公司');
...
CREATE TABLE `pms_user_position`  (
  ...
  `sort` tinyint(11) NULL DEFAULT 0,
  `create_time` datetime(0) NULL DEFAULT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 1273 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'PC端登录令牌表' ROW_FORMAT = Compact;
...
INSERT INTO `pms_user_token` VALUES (1272, 119, 'xiaoming', '750483325c1a847d869eff083884f2fe', 1532436426, NULL, '127.0.0.1');
