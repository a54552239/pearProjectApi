...
-- ----------------------------
DROP TABLE IF EXISTS `pear_project_report`;
CREATE TABLE `pear_project_report`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for pear_task_work_time
-- ----------------------------
DROP TABLE IF EXISTS `pear_task_work_time`;
